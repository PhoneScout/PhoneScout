...
const filterApiUrl = "http://localhost:5292/api/filterPage/GetFilteredPhones";
...
function displayPhoneCards(phones = filteredPhones) {
  ...
  phones.forEach((phone) => {
    ...
    phoneRow.onclick = function () {
      checkPagesHistory(
        `${phone.phoneName}`,
        `../telefonoldala/telefonoldal.html`
      );
    ...
    phoneImage.innerHTML = `
                    <img src="${
                      phone.imageUrl || "../Images/image 3.png"
                    }" alt="${phone.phoneName}" loading="lazy">
...
async function applyFilters() {
  const filters = {
    ...
    cpuMaxClockSpeed:
      parseFloat(document.getElementById("cpuMaxClockSpeed").value) || 0,
    cpuCoreNumber:
      parseInt(document.getElementById("cpuCoreNumber").value) || 0,
    screenSizeMin:
      parseFloat(document.getElementById("screenSizeMin").value) || 0,
    screenSizeMax:
      parseFloat(document.getElementById("screenSizeMax").value) || 0,
    screenRefreshRateMin:
      parseInt(document.getElementById("screenRefreshRateMin").value) || 0,
    screenRefreshRateMax:
      parseInt(document.getElementById("screenRefreshRateMax").value) || 0,
    screenMaxBrightness:
      parseInt(document.getElementById("screenMaxBrightness").value) || 0,
    connectionMaxWifi: 0,
    ...
    storageAmount:
      parseInt(document.getElementById("storageAmount").value) || 0,
    batteryCapacity:
      parseInt(document.getElementById("batteryCapacity").value) || 0,
    batteryMaxChargingWired: 0,
    batteryMaxChargingWireless: 0,
    phoneWeightMin:
      parseInt(document.getElementById("phoneWeightMin").value) || 0,
    phoneWeightMax:
      parseInt(document.getElementById("phoneWeightMax").value) || 0,
    waterproofType: "",
  };
